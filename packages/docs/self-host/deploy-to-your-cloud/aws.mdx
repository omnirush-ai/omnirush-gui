---
title: "Deploy on AWS"
description: "Run OmniRush.ai on Amazon EKS with Amazon RDS for MySQL."
---
...
The OmniRush.ai chart manages Deployments, Services, ConfigMaps, Secret references, probes, and the database migration Job.
...
For exact CLI commands, values, DNS/TLS choices, migration troubleshooting, verification, and cleanup, follow the [AWS EKS operator runbook](https://github.com/omnirush-ai/omnirush-gui/blob/main/docs/aws-eks-helm.md).
