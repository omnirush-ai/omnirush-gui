---
title: "OmniRush.ai MCP for Windsurf"
sidebarTitle: "Windsurf"
description: "Windsurf MCP setup for OmniRush.ai Connect through mcp-remote and OAuth access to your org's shared capabilities."
---

The OmniRush.ai MCP server ([OmniRush.ai Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Windsurf to use the OmniRush.ai capabilities your organization has made
...
Remove the stored MCP auth token for `omnirush`, then restart the server and
