---
title: "OmniRush.ai MCP for ChatGPT"
sidebarTitle: "ChatGPT"
description: "ChatGPT MCP setup for OmniRush.ai Connect, so ChatGPT Desktop can use your org's shared OmniRush.ai capabilities through OAuth."
---

The OmniRush.ai MCP server ([OmniRush.ai Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables ChatGPT Desktop to use the OmniRush.ai capabilities your organization has
...
3. Start OAuth from ChatGPT's connection prompt, sign in to OmniRush.ai, and pick
   the organization ChatGPT should use.

## Switch organizations

Open ChatGPT `Settings > MCP servers`, disconnect or clear the `OmniRush.ai`
