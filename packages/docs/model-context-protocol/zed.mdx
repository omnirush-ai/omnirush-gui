---
title: "OmniRush.ai MCP for Zed"
sidebarTitle: "Zed"
description: "Zed MCP setup for OmniRush.ai Connect through mcp-remote and OAuth access to your org's shared capabilities."
---

The OmniRush.ai MCP server ([OmniRush.ai Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Zed to use the OmniRush.ai capabilities your organization has made
