...
- The final OmniRush.ai auth origin, for example `https://app.omnirushlabs.com`.
...
| Entity ID | The `entityID` from OmniRush.ai **Metadata URL**, normally `https://app.omnirushlabs.com` for OmniRush.ai Cloud |
...
```xml
<EntityDescriptor entityID="https://app.omnirushlabs.com">
```

For OmniRush.ai Cloud, that `entityID` is the same for the SSO test and for the
