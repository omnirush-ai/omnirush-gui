...
Set up a team on [app.omnirushlabs.com](https://app.omnirushlabs.com), publish your first skill, and trigger it from the desktop app — in about 15 minutes.
...
<Note>
**Seats:** every workspace includes **5 free seats**. If you need more seats, SSO, or early access to analytics, [reach out](mailto:founders@omnirushlabs.com).
</Note>
...
Head to [app.omnirushlabs.com](https://app.omnirushlabs.com). Enter your work email and press **Next** — OmniRush.ai routes you to the right sign-in step automatically.
...
Now switch to the [OmniRush.ai desktop app](https://omnirushlabs.com). On the welcome screen, click **Joining a team? Sign in** and sign in with the same account.
...
<Note>
**Need more?** The first 5 users in your organization are free; additional users are $10 per user per month. For SSO or early analytics access, [contact us](mailto:founders@omnirushlabs.com).
</Note>
