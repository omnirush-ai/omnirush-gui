...
description: "Create an org-managed provider in OmniRush.ai Cloud and import it into the desktop app"
---
...
## Create the provider in OmniRush.ai Cloud
...
<Frame>
  ![Managed LLM provider detail in OmniRush.ai Cloud](/images/cloud-managed-llm-provider-detail.png)
</Frame>
...
OmniRush.ai writes the imported provider into the workspace `opencode.jsonc` and stores the org credential for that workspace.

## Update or remove it later

- Use `Sync` after changing models or access in OmniRush.ai Cloud.
