...
OmniRush.ai Cloud is available at [app.omnirushlabs.com](https://app.omnirushlabs.com/). It is for teams that want shared identity, Collections, managed connections and models, desktop policies, or hosted workspaces.
...
1. Open [app.omnirushlabs.com](https://app.omnirushlabs.com/) in your browser.
...
1. Open the `dashboard/org_settings` [page](https://app.omnirushlabs.com/dashboard/org-settings) in the cloud app.
...
default is `https://app.omnirushlabs.com`.
...
back to `https://app.omnirushlabs.com`. When you change the Cloud URL in
