---
title: "Stewardship"
description: "The promises behind OmniRush.ai's open-core split: what stays open, what can move between tiers, and how the MIT conversion works."
---

OmniRush.ai is an open-core product: the desktop app and core platform are MIT,
and the `ee/` directory (OmniRush.ai Den, the org control plane) is
...
The OmniRush.ai name, logo, and product names are trademarks of Different AI,
...
- **Allowed without permission:** factually identifying that you use or built
  on OmniRush.ai ("powered by OmniRush.ai", "built with OmniRush.ai"), unmodified use
  of the app with its own branding, and nominative references in
  documentation, reviews, and talks.
- **Requires an Enterprise plan (internal white-labeling):** replacing OmniRush.ai
...
[sales@omnirushlabs.com](mailto:sales@omnirushlabs.com).
