...
description: "See which OmniRush.ai languages ship today and help us improve them."
---

OmniRush.ai already ships with a growing set of languages, and we want to keep expanding that list.
...
<Frame>
  <iframe
    ...
    title="OmniRush.ai missing languages overview"
...
If you want to improve an existing translation, start in [`apps/app/src/i18n/locales`](https://github.com/omnirush-ai/omnirush-gui/tree/main/apps/app/src/i18n/locales).
...
If you want to add a new language to OmniRush.ai, the basic file changes are:
...
If you want to follow broader localization work, language requests, or upcoming improvements, check the [i18n roadmap](https://github.com/omnirush-ai/omnirush-gui/issues/1385).
