...
description: "OmniRush.ai's public pricing — Free, Team, and Enterprise — and how the MIT + OmniRush.ai EE License split works."
---

Our pricing is public, like the rest of our handbook. The same prices apply
whether you use OmniRush.ai Cloud or self-host. There are no deployment fees, and
...
| **Users** | Up to 5 | Up to 100 | Unlimited (volume pricing above 100 — [talk to sales](mailto:info@omnirush.ai)) |
...
[subscription terms](https://github.com/omnirush-ai/omnirush-gui/blob/main/ee/apps/landing/app/terms/subscription/subscription-terms.md) and
...
The [repository](https://github.com/omnirush-ai/omnirush-gui) uses a
...
- **Everything under `ee/` (OmniRush.ai Den, the org control plane) is
  source-available under the
  [OmniRush.ai EE License](https://github.com/omnirush-ai/omnirush-gui/blob/main/ee/LICENSE).**
...
[subscription terms](https://github.com/omnirush-ai/omnirush-gui/blob/main/ee/apps/landing/app/terms/subscription/subscription-terms.md). Every
...
[ask us](mailto:info@omnirush.ai). If you want a supported pilot
instead (a dedicated engineering contact, deployment guidance, and response
targets), [talk to sales](mailto:info@omnirush.ai).
