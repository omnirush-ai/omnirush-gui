...
Most users just use the [desktop app](https://omnirushlabs.com/download). Self-hosting is for teams that want OmniRush.ai to run on their own server, VPC, or private cloud and then connect the desktop app to it remotely.

Want hosted workspaces, team Collections, or shared providers without running infra? Use [OmniRush.ai Cloud](/cloud/get-started) instead. Rolling this out across a company? [Book a call](https://calendar.app.google/86QpCENvhfEzDFLu5) about [Enterprise](/cloud/enterprise).
