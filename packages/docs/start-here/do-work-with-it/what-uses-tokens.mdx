...
description: "Understand when OmniRush.ai model usage starts and how to control it."
---

OmniRush.ai uses model tokens when a member actually runs work. Setup actions do not consume tokens by themselves.
