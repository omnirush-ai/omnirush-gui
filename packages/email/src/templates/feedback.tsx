...
export function FeedbackEmail({
  ...
  const metadata = [
    ...
    ["OmniRush.ai server", omnirushServerVersion],
  ...
  return (
    <Html>
      <Head />
      <Preview>{name} sent an OmniRush.ai {label} from {entrypoint || source || "unknown"}</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.eyebrow}>{isContact ? "OmniRush.ai contact" : "OmniRush.ai feedback"}</Text>
