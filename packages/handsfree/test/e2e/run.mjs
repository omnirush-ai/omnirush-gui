...
const HELPER_APP = process.env.OMNIRUSH_COMPUTER_USE_HELPER
  ?? join(repoRoot, "apps/desktop/resources/helpers/OmniRush.ai Computer Use.app");
...
try { execSync(`pkill -f 'OmniRush.ai Computer Use.app'`); } catch {}
