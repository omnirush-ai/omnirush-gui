...
Reference implementation for server-side remote MCP consumption in OmniRush.ai.
...
not change local/direct engine MCP, the incoming OmniRush.ai Cloud meta-MCP,
