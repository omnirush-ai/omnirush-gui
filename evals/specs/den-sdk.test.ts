...
const remote = process.env.OMNIRUSH_EVAL_DAYTONA === "1" || Boolean(process.env.OMNIRUSH_EVAL_DEN_API_URL);
    ...
    try {
      ...
      try {
        ...
        const override = await scoped.getV1Org(undefined, {
          headers: { "x-omnirush-org-id": secondOrg.id }, throwOnError: true,
        });
