 ...
 * (@omnirush/hosts, @omnirush/behaviors, @omnirush/cdp) into declarative
...
import { docShotReceiptSchema } from "@omnirush/review";
import { emulateFocus, freezeMotion, paintBackdrop, setViewport } from "@omnirush/cdp";
