...
/**
 * @param {Partial<import("@omnirush/types/desktop-ipc").DesktopBootstrapConfig>} config
 ...
 * @param {{
 *   persistBootstrap: (
 *     config: Partial<import("@omnirush/types/desktop-ipc").DesktopBootstrapConfig>
 *   ) => Promise<import("@omnirush/types/desktop-ipc").DesktopBootstrapConfig>,
