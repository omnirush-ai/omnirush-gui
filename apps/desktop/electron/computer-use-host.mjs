...
export async function createComputerUseHost({ profile, executable }) {
  ...
  return {
    ...
    action(value) {
      ...
      entry.child.stdin.write(`${JSON.stringify({ jsonrpc: "2.0", method: "omnirush/ui", params: { id: value.id, action: value.action, windowId: value.windowId } })}\n`);
    },
