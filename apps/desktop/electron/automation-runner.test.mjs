...
test("desktop Automation execution creates a normal visible local OmniRush.ai thread", async () => {
  const requests = []
  ...
  assert(localRequests.every((request) => new Headers(request.options.headers).get("x-omnirush-task-recovery") === "off"))
