...
const originalElectronBridge = typeof window === "undefined" ? undefined : window.__OMNIRUSH_ELECTRON__;

beforeEach(() => {
  if (typeof window !== "undefined") window.__OMNIRUSH_ELECTRON__ = undefined;
});

afterEach(() => {
  Object.defineProperty(globalThis, "fetch", { configurable: true, value: originalFetch });
  if (typeof window !== "undefined") window.__OMNIRUSH_ELECTRON__ = originalElectronBridge;
});
