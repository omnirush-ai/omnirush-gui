...
import { OmniRushSessionCreateTool } from "../src/components/tools/omnirush-session-create";
...
function sessionCreatePart(): DynamicToolUIPart {
  return {
    type: "dynamic-tool",
    toolName: "omnirush_session_create",
...
describe("OmniRushSessionCreateTool", () => {
    ...
    const html = renderToStaticMarkup(
      <MemoryRouter>
        <MessageListProvider
          ...
          onMcpRetry={noop}
        >
          <OmniRushSessionCreateTool part={sessionCreatePart()} />
        </MessageListProvider>
      </MemoryRouter>,
    );

    expect(html).toContain("data-omnirush-session-create-card");
