...
import { parseAutomationProposal } from "../src/components/tools/omnirush-automation-proposal";
...
describe("Automation proposal card", () => {
  test("reads a proposal out of an omnirush_execute result, string or object", () => {
