...
export type OmniRushSessionCreateResult = {
  ok: boolean
...
export function parseOmniRushSessionCreateResult(output: unknown): OmniRushSessionCreateResult | null {
...
export function OmniRushSessionCreateTool({ part }: { part: DynamicToolUIPart }) {
  ...
  const result = parseOmniRushSessionCreateResult(part.output)
  if (!result) {
  ...
  return (
    <div
      ...
      data-omnirush-session-create-card
