...
import { usePublishOmniRushContext } from "./control/control-provider";
import { buildOmniRushContext } from "./omnirush-context-projector";
import { useUiStateStore } from "./ui-state-store";

export function OmniRushContextPublisher() {
  ...
  const context = useMemo(() => buildOmniRushContext({
    route,
    revision,
  ...
  usePublishOmniRushContext(context);
  return null;
}
