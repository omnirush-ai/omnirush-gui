...
import { isDirectModelProvider } from "@/app/lib/provider-catalog";
  ...
  const handleApiSubmit = async () => {
    ...
    try {
      ...
      toast.success(`${selectedEntry.name} connected`, {
        description: "API key saved locally on this device.",
      });
            ...
            <div className="-mr-1 min-h-0 flex-1 space-y-2 overflow-y-auto pr-1">
              ...
              {resolvedView === "api" && selectedEntry ? (
                <div className="space-y-4">
                  ...
                  <div className="text-xs text-gray-10">Paste your API key to connect.</div>
                  <TextInput
                    label="API key"
                    type="password"
                    placeholder="sk-..."
