...
import { dedupeModelOptions, modelEquals, resolveProviderDisplayName } from "../../../../app/utils";
...
export function ModelPickerModal(props: ModelPickerModalProps) {
  ...
  const filteredOptions = useMemo(() => {
    ...
    const visibleOptions = dedupeModelOptions(
      props.options.filter((option) => isSupportedModelProvider(option.providerID)),
    );
  ...
  const providerGroups = useMemo<ProviderGroup[]>(() => {
    ...
    return groups.sort((a, b) => {
      ...
      const accessDifference = a.accessRank - b.accessRank;
