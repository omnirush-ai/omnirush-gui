export const ADVANCED_SETTINGS_SECTIONS = [
  ...
  { id: "runtime", title: "Runtime", keywords: ["opencode engine", "omnirush server", "connection status"] },
  { id: "agent-access", title: "Agent access diagnostics", keywords: ["cloud mcp", "health", "tools", "connections"] },
  { id: "config-sources", title: "omnirush.ai config sources", keywords: ["runtime db", "injected config", "project config", "global config"] },
