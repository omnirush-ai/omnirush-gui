...
// omnirush-server, desktop cloud sync). Extracted from den.ts so that modules
...
export type DenOrgExtensionProjection = {
  ...
  name: string;
  description: string | null;
  sourceFormat: OmniRushExtensionSourceFormat;
  manifest: OmniRushExtensionManifest | null;
};
