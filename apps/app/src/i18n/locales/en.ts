 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, omnirush.ai) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "omnirush.ai server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "omnirush.ai server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "composer.connect_skill_prompt": "Use the \"{name}\" skill from the \"{marketplace}\" marketplace. Find it with omnirush-cloud_search_capabilities, then call omnirush-cloud_execute_capability with the exact capability name \"{capability}\", follow the returned skill content, and use it to ",
  ...
  "connect.connected_to_cloud": "Connected to omnirush.ai Cloud",
  "connect.connected_to_org": "Connected to {name}",
  "connect.diagnostics_action_label": "Recommended action",
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed omnirush.ai agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved omnirush.ai agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "omnirush.ai agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective omnirush.ai agent resolution",
  "connect.diagnostics_check_cloud_endpoint_differential": "Runtime probe vs engine verdict",
  "connect.diagnostics_check_cloud_endpoint_transport": "omnirush.ai Cloud endpoint transport",
  "connect.diagnostics_check_cloud_tool_catalog": "omnirush.ai Cloud tool catalog",
  ...
  "connect.diagnostics_global_cloud_mcp": "Global omnirush.ai Cloud MCP",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and omnirush.ai-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_org_description": "These connections operate behind the single omnirush.ai Cloud meta-MCP and are not injected as separate engine MCPs.",
  ...
  "connect.diagnostics_owner_opencode_engine": "omnirush.ai engine",
  "connect.diagnostics_owner_omnirush_client": "omnirush.ai client",
  "connect.diagnostics_owner_omnirush_server": "omnirush.ai server",
  "connect.diagnostics_owner_omnirush_support": "omnirush.ai support",
  ...
  "connect.diagnostics_configured_agent": "Configured omnirush.ai agent",
  "connect.diagnostics_effective_agent": "Effective omnirush.ai agent",
  "connect.diagnostics_agent_state": "omnirush.ai agent state",
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote omnirush.ai workspaces. Use a remote omnirush.ai workspace to run this report.",
  "connect.diagnostics_workspace_cloud_mcp": "Selected workspace omnirush.ai Cloud MCP",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from omnirush.ai Den.",
  ...
  "connect.pitch_title": "Connect is the new way omnirush.ai lets you share workflows with your team.",
  ...
  "connect.state_not_configured_action": "Sign in to omnirush.ai Cloud to finish setup.",
  ...
  "connect.state_unavailable_action": "Restart omnirush.ai. If this continues, run diagnostics.",
  ...
  "config.engine_reload_desc": "Restart the omnirush.ai server for this workspace.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected omnirush.ai servers.",
  ...
  "config.server_needed_hint": "omnirush.ai server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an omnirush.ai server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "omnirush.ai server",
  ...
  "config.server_sharing_title": "omnirush.ai server sharing",
  "config.server_url_hint": "Use the URL shared by your omnirush.ai server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "omnirush.ai server URL",
  "config.server_url_label": "omnirush.ai Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable omnirush.ai server workspace to edit authorized folders.",
  ...
  "context_panel.effective_permissions_unavailable": "Connect to an omnirush.ai server workspace with a running engine to see how agents run here.",
  ...
  "context_panel.permission_source_omnirush": "omnirush.ai",
  "context_panel.permission_source_workspace": "This workspace's opencode.json",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "omnirush.ai server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "omnirush.ai server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "omnirush.ai server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable omnirush.ai server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted omnirush.ai worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted omnirush.ai worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an omnirush.ai server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the omnirush.ai server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted omnirush.ai worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update omnirush.ai and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and omnirush.ai will reconnect here automatically.",
  ...
  "den.cloud_provider_needs_server": "Needs omnirush.ai server",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access omnirush.ai Cloud.",
  "den.cloud_section_title": "omnirush.ai Cloud",
  "den.cloud_sleep_hint": "Sign in to omnirush.ai Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use omnirush.ai Cloud.",
  "den.open_dashboard": "Open Den dashboard",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "omnirush.ai Cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but omnirush.ai Cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid omnirush.ai sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete omnirush.ai Cloud sign-in.",
  ...
  "den.error_signout_failed": "Could not sign out of omnirush.ai Cloud. Try again.",
  ...
  "den.signin_code_note": "Accepts an omnirush://den-auth link or the raw one-time grant.",
  "den.signin_link_copied": "Copied",
  "den.signin_link_hint": "If your browser doesn't bounce back into omnirush.ai automatically, paste the sign-in link or one-time code from omnirush.ai Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "omnirush://den-auth?... or pasted code",
  "den.signin_title": "Sign in to omnirush.ai Cloud",
  "den.signing_in": "Finishing omnirush.ai Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect omnirush.ai.",
  "den.status_browser_signin_paste": "Sign in in your browser, copy the omnirush.ai link, then paste it below.",
  "den.status_browser_signup": "Finish account creation in your browser to connect omnirush.ai.",
  "den.status_browser_signup_paste": "Create your account in the browser, copy the omnirush.ai link, then paste it below.",
  "den.status_cloud_signed_in_as": "Connected omnirush.ai Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected omnirush.ai Cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your omnirush.ai Cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. omnirush.ai is using the default Cloud control plane.",
  ...
  "extensions.add_picker_hint": "Create something in omnirush.ai, add an MCP server by URL, or manage a hosted service connection in Den.",
  ...
  "extensions.kind_connection_hint": "Browse hosted services and manage setup for this organization in omnirush.ai Den.",
  ...
  "extensions.create_skill_hint": "Saved to your organization Library. Agents can load these instructions from omnirush.ai Cloud.",
  ...
  "extensions.add_sign_in_required": "Sign in to omnirush.ai Cloud to add items to Library.",
  ...
  "extensions.add_plugin_collection_hint": "Publishing puts the plugin in the collection so members find it in the omnirush.ai app.",
  ...
  "extensions.add_unauthorized": "Your omnirush.ai Cloud session expired. Sign in again, then create the skill.",
  ...
  "extensions.empty_connections": "{org} has not shared any connections with you yet. An admin adds them in the omnirush.ai Cloud dashboard.",
  "extensions.empty_connections_signed_out": "Connections are shared by your organization. Sign in to omnirush.ai Cloud from Account to see yours.",
  ...
  "extensions.marketplace_description": "Browse omnirush.ai built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through omnirush.ai Cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "extensions.surface_cloud": "omnirush.ai Cloud",
  ...
  "extensions.plugins_opencode_header": "Plugins (omnirush.ai)",
  ...
  "mcp.toggle_requires_server": "Connect to an omnirush.ai server to enable or disable MCPs.",
  "mcp.action_reconnect": "Reconnect",
  "mcp.add_modal_subtitle": "Connect a custom MCP to this workspace. This setup stays separate from organization-managed services in omnirush.ai Connect.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so omnirush.ai can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, omnirush.ai needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, omnirush.ai needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize omnirush.ai",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from omnirush.ai.",
  ...
  "mcp.managed_oauth_unavailable": "Secure storage is unavailable on this device, so omnirush.ai-managed sign-ins are paused.",
  "mcp.name_required": "Enter a server name.",
  "mcp.name_reserved_omnirush_connect": "This name is reserved for omnirush.ai Connect. Choose a different name for the workspace MCP.",
  "mcp.no_apps_hint": "Connect one above to get started.",
  "mcp.no_apps_yet": "No apps connected yet",
  "mcp.oauth": "Sign in",
  "mcp.oauth_advanced_hint": "This desktop handles sign-in and token refresh, and encrypts the OAuth credentials in this device's protected app storage. This is separate from omnirush.ai Connect and does not connect other devices.",
  ...
  "mcp.oauth_secret_warning": "omnirush.ai encrypts these credentials in local app data. They are not written to your workspace or omnirush.ai configuration. Keep client secrets out of chats and source control.",
  ...
  "mcp.quick_connect_omnirush_cloud_desc": "Manage your org, workers, skills, providers, and team config from chat. Try: \"List all workers in my org\" or \"Push this skill to the team.\"",
  "mcp.quick_connect_omnirush_cloud_title": "omnirush.ai Cloud Control",
  "mcp.quick_connect_omnirush_ui_desc": "Let agents see and drive the omnirush.ai app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_omnirush_ui_title": "omnirush.ai UI Control",
  ...
  "notifications.empty_hint": "Updates from omnirush.ai Cloud and your workspaces will show up here.",
  "notifications.engine_reloaded": "Updates applied",
  "notifications.just_now": "Just now",
  "notifications.reconnect_failed": "Couldn't reconnect to the omnirush.ai server",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. omnirush.ai will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// omnirush.ai server URL.",
  "welcome.organization_server_link": "Using omnirush.ai on-premises?",
  "welcome.organization_server_url_label": "Organization server URL",
  "welcome.organization_server_url_placeholder": "https://omnirush.yourcompany.com",
  "welcome.team_signin": "Joining a team? Sign in",
  "welcome.use_cloud": "Use omnirush.ai Cloud",
  "welcome.use_cloud_subtitle": "Sign in for hosted omnirush.ai and team features",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. omnirush.ai will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and omnirush.ai can pick them up.",
  ...
  "join_org.confirm_invite_body": "Only continue if you trust {host}. omnirush.ai will use it as your organization server and open the invite in your browser.",
  ...
  "join_org.error_invalid": "That does not look like an omnirush.ai invite link, install link, server URL, or sign-in code.",
  "join_org.error_invalid_config": "This link opened, but it did not contain a valid omnirush.ai organization setup. Ask your admin for a fresh one.",
  "join_org.error_network": "omnirush.ai could not reach that organization server. Check your connection or VPN, then try again.",
  "join_org.input_hint": "Accepted: invite links, install links, server URLs, “server token”, omnirush://den-auth links, or a raw sign-in code.",
  ...
  "join_org.invite_opened": "Your invite opened in the browser — finish joining there. omnirush.ai now points at {host} and is ready when you come back.",
  "join_org.omnirush_cloud": "omnirush.ai Cloud",
  ...
  "plugins.title": "omnirush.ai plugins",
  ...
  "providers.disabled_in_config_suffix": "and disabled it in omnirush.ai config.",
  ...
  "session.cmd_session_id_meta": "Copy",
  "session.cmd_session_id_title": "Session ID",
  ...
  "session.cmd_reload_config_title": "Reload omnirush.ai config",
  ...
  "session.delete_failed": "Couldn't delete session",
  ...
  "session.delete_unavailable": "The workspace's local server is not connected yet. Try again in a moment.",
  "session.deleting": "Deleting...",
  "session.deny": "Deny",
  "session.details": "Details",
  "session.details_label": "Details",
  "session.doom_loop_label": "Doom Loop",
  "session.doom_loop_message": "omnirush.ai detected repeated tool calls with identical input and is asking whether it should continue after repeated failures.",
  ...
  "session.engine_catching_up_title": "omnirush.ai is catching up",
  ...
  "session.engine_not_responding_title": "omnirush.ai is not responding",
  ...
  "session.engine_unavailable_title": "omnirush.ai unavailable",
  ...
  "session.permission_message": "omnirush.ai is requesting permission to continue.",
  "session.permission_message_bash": "Review the command scope before allowing omnirush.ai to continue.",
  "session.permission_message_edit": "Review the file and diff before allowing omnirush.ai to make changes.",
  ...
  "session.share_local_host_not_ready": "Local omnirush.ai host is not ready yet.",
  "session.share_missing_host_url": "Missing omnirush.ai host URL.",
  "session.share_missing_token": "Missing omnirush.ai token.",
  ...
  "session.share_opencode_base_url": "omnirush.ai base URL",
  "session.share_omnirush_workers_only": "Share service links are available for omnirush.ai workers.",
  ...
  "settings.api_keys_info": "API keys are stored locally by omnirush.ai. Environment-backed providers must be changed in the worker environment and then reloaded.",
  ...
  "settings.privacy_section_desc": "Control what omnirush.ai shares to improve the product.",
  "settings.privacy_title": "Privacy",
  "settings.auto_compact_desc": "Controls omnirush.ai compaction.auto for this workspace. Reload the engine after changing it.",
  ...
  "settings.capabilities_title": "omnirush.ai server capabilities",
  "settings.capabilities_unavailable": "Capabilities unavailable. Connect with a client token.",
  "settings.change": "Change",
  "settings.choose": "Choose",
  "settings.clear": "Clear",
  "settings.config_updated": "Configuration updated. Reload the engine if the change affects omnirush.ai.",
  ...
  "settings.custom_binary_hint": "Use this to point omnirush.ai at a local omnirush.ai build",
  "settings.custom_binary_label": "Custom omnirush.ai binary",
  ...
  "settings.debug_opencode_version": "omnirush.ai: {version}",
  "settings.debug_omnirush_server_version": "omnirush.ai server: {version}",
  ...
  "settings.runtime_config_one_writer_rule": "omnirush.ai writes only the managed runtime config file; user omnirush.ai config stays user-owned.",
  ...
  "settings.runtime_config_cleanup_no_files": "No legacy omnirush.ai config files found.",
  "settings.runtime_config_removed_keys": "Removed: {keys}",
  "settings.runtime_config_no_removed_keys": "No omnirush.ai-managed keys removed.",
  "settings.runtime_config_backup_path": "Backup: {path}",
  "settings.runtime_config_no_backup": "No backup needed.",
  "settings.error": "Error",
  "settings.idle": "Idle",
  "settings.loading": "Loading",
  "settings.deeplink_hint": "Accepts omnirush:// or omnirush-dev:// links.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which omnirush.ai events can appear as native operating system notifications.",
  ...
  "settings.diag_opencode_binary": "omnirush.ai binary: {binary}",
  ...
  "settings.diagnostics_card_desc": "Share a sanitized report when something goes wrong. Tokens are redacted and chat content is not included. The logs folder holds omnirush-server.log.",
  "settings.diagnostics_card_title": "Report a problem",
  "settings.diagnostics_failed": "Could not prepare diagnostics",
  "settings.diagnostics_open_logs": "Open logs folder",
  "settings.diagnostics_open_logs_done": "Opened the logs folder",
  "settings.diagnostics_open_logs_failed": "Could not open the logs folder",
  "settings.diagnostics_section_title": "Diagnostics",
  ...
  "settings.enable_exa_desc": "Applies the next time omnirush.ai is started by omnirush.ai. Off by default.",
  ...
  "settings.engine_desc": "Choose how omnirush.ai runs locally.",
  ...
  "settings.exa_restart_hint": "Restart omnirush.ai after changing this setting.",
  ...
  "settings.feedback_title": "Help shape omnirush.ai",
  ...
  "settings.nuke_hint": "Use this only when you want to fully reset the desktop app and its omnirush.ai runtime state.",
  ...
  "settings.nuke_confirmation_hint": "omnirush.ai will revoke your cloud session best-effort, wipe local state, then relaunch.",
  ...
  "settings.nuke_dialog_desc": "This removes local omnirush.ai, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.nuke_survives_app": "The installed omnirush.ai app and protocol registration stay installed.",
  "settings.nuke_survives_bootstrap": "Bootstrap / organization server: {path}",
  "settings.nuke_survives_title": "Will survive",
  "settings.nuke_survives_workspaces": "Workspace folders and your files inside them are not touched, but each workspace's omnirush.ai state (.opencode/omnirush) is removed.",
  "settings.off": "Off",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste an omnirush.ai deeplink or share URL to open it.",
  ...
  "settings.organization_server_default": "Using standard omnirush.ai Cloud.",
  "settings.organization_server_desc": "Point omnirush.ai at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's omnirush.ai server URL. Saving signs you out so omnirush.ai can re-hydrate against that server.",
  ...
  "settings.opencode_engine_label": "omnirush.ai engine",
  "settings.opencode_engine_sidecar": "omnirush.ai engine",
  "settings.opencode_engine_sidecar_desc": "Local omnirush.ai process managed by omnirush.ai.",
  "settings.opencode_sdk_desc": "Browser → engine connection.",
  "settings.opencode_sdk_title": "omnirush.ai SDK link",
  "settings.opencode_section_label": "omnirush.ai",
  "settings.opening": "Open deeplink",
  "settings.omnirush_config_sidecar_desc": "Local omnirush.ai server (Bun) that hosts approvals, audit, and omnirush.ai lifecycle.",
  "settings.omnirush_diagnostics_title": "omnirush.ai server diagnostics",
  "settings.omnirush_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.omnirush_server_label": "omnirush.ai server",
  ...
  "settings.quit_hint": "omnirush.ai quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect omnirush.ai server.",
  "settings.reconnected": "Reconnected to omnirush.ai server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears omnirush.ai cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears omnirush.ai cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. omnirush.ai will restart.",
  ...
  "settings.reset_onboarding_description": "Clears omnirush.ai preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears omnirush.ai local preferences and workspace onboarding markers.",
  "settings.reset_omnirush_desc_dev": "With dev mode active, it only clears the isolated omnirush.ai dev state inside omnirush-dev-data.",
  "settings.reset_omnirush_desc_prod": "With dev mode active, it only clears the isolated omnirush.ai dev state inside omnirush-dev-data.",
  "settings.reset_omnirush_title": "Reset omnirush.ai state",
  ...
  "settings.restart_blocked_message": "The update is ready, but omnirush.ai will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart omnirush.ai",
  "settings.restart_omnirush_server": "Restart omnirush.ai server",
  ...
  "settings.services_section_desc": "Local services that power this omnirush.ai session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting omnirush.ai.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs omnirush.ai will use after local overrides and bootstrap files are applied.",
  "settings.server_endpoints_local_dev": "Local dev server",
  "settings.server_endpoints_mismatch": "Doesn't match API endpoint",
  "settings.server_endpoints_not_configured": "No omnirush-cloud MCP entry configured",
  ...
  "settings.runtime_desc": "Status for your local engine and omnirush.ai server.",
  ...
  "settings.tab_connect": "omnirush.ai Connect",
  ...
  "settings.tab_description_appearance": "Adjust how omnirush.ai looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected omnirush.ai workspace plus its runtime connection.",
  ...
  "settings.environment.footer_hint": "OMNIRUSH_ and OPENCODE_ keys are reserved for app/runtime wiring. Configure OpenCode runtime settings from your shell.",
  "settings.environment.override_hint": "Environment variables set before omnirush.ai starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "omnirush.ai will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "omnirush.ai is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but omnirush.ai status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "OMNIRUSH_ and OPENCODE_ names are managed by omnirush.ai/OpenCode.",
  ...
  "settings.update_blocked_org": "omnirush.ai {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  "settings.update_blocked_policy": "omnirush.ai {version} is available, but this installation is not eligible for it yet.",
  ...
  "settings.update_open_installer_button": "Open installer",
  "settings.update_installer_opened": "Installer opened. Drag omnirush.ai to Applications, replace the old copy, then reopen it.",
  "settings.update_manual_install_hint": "This build is not signed with a Developer ID, so it cannot replace itself. The installer opens and omnirush.ai quits.",
  "settings.update_open_installer_now_title": "Open the installer?",
  "settings.update_open_installer_now_message": "{appName} will quit and the installer will open. Drag omnirush.ai to Applications, replace the old copy, then reopen it.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts omnirush.ai and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts omnirush.ai now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep omnirush.ai up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an omnirush.ai host, then choose it from the list to import this skill.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected omnirush.ai server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active omnirush.ai Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active omnirush.ai Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "omnirush.ai Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full omnirush.ai features",
  ...
  "status.omnirush_ready": "omnirush.ai Ready",
  ...
  "status.reloading_config": "Reloading omnirush.ai config",
  "status.running": "Running",
  "status.send_feedback": "Send feedback",
  "status.settings": "Settings",
  "system.reload_body_agents": "omnirush.ai loads agents at startup. Reload the engine to make updated agents available.",
  "system.reload_body_commands": "omnirush.ai loads commands at startup. Reload the engine to make updated commands available.",
  "system.reload_body_config": "OpenCode reads opencode.json at startup. Reload the engine to apply configuration changes.",
  "system.reload_body_default": "omnirush.ai detected changes that require reloading the omnirush.ai instance.",
  "system.reload_body_mcp": "omnirush.ai loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "omnirush.ai detected omnirush.ai configuration changes. Reload the engine to apply them.",
  "system.reload_body_plugins": "OpenCode loads npm plugins at startup. Reload the engine to apply opencode.json changes.",
  "system.reload_body_skills": "omnirush.ai can cache skill discovery/state. Reload the engine to make newly installed skills available.",
  ...
  "workspace_list.remove_failed": "Couldn't remove workspace",
  ...
  "workspace_list.remote_worker_unavailable_hint": "omnirush.ai can't load tasks from this worker until the connection is fixed.",
  ...
  "session_management.copy_session_id": "Copy session ID",
  "session_management.session_id_copied": "Session ID copied",
  "session_management.session_id_copy_failed": "Couldn't copy the session ID",
