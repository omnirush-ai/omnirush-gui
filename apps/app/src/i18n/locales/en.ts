...
export default {
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote OpenCode workspaces. Use a remote OmniRush.ai workspace to run this report.",
  ...
  "mcp.oauth_secret_warning": "OmniRush.ai encrypts these credentials in local app data. They are not written to your workspace or OpenCode configuration. Keep client secrets out of chats and source control.",
  ...
  "settings.custom_binary_hint": "Use this to point OmniRush.ai at a local OpenCode build",
  ...
  "settings.runtime_config_one_writer_rule": "OmniRush.ai writes only the managed runtime config file; user OpenCode config stays user-owned.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by OmniRush.ai. Off by default.",
  ...
  "settings.nuke_dialog_desc": "This removes local OmniRush.ai, OpenCode, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by OmniRush.ai.",
  ...
  "settings.omnirush_config_sidecar_desc": "Local OmniRush.ai server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  ...
  "settings.reset_omnirush_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside omnirush-dev-data.",
  "settings.reset_omnirush_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside omnirush-dev-data.",
  "settings.reset_omnirush_title": "Reset OmniRush.ai + OpenCode state",
  ...
  "system.reload_body_default": "OmniRush.ai detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "OmniRush.ai detected OpenCode configuration changes. Reload the engine to apply them.",
