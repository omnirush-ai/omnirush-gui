...
export default {
  ...
  "settings.custom_binary_hint": "Use para apontar o OmniRush.ai para um build local do OpenCode",
  ...
  "settings.enable_exa_desc": "Aplica-se quando o OmniRush.ai inicia o OpenCode.",
  ...
  "settings.reset_omnirush_desc_dev": "Com o modo dev ativo, limpa apenas o estado isolado do OpenCode dev dentro de omnirush-dev-data.",
  "settings.reset_omnirush_desc_prod": "Com o modo dev ativo, limpa apenas o estado isolado do OpenCode dev dentro de omnirush-dev-data.",
  "settings.reset_omnirush_title": "Redefinir estado do OmniRush.ai + OpenCode",
  ...
  "system.reload_body_default": "O OmniRush.ai detectou mudanças que exigem recarregar a instância do OpenCode.",
  "system.reload_body_mcp": "O OpenCode carrega servidores MCP na inicialização. Recarregue o engine para ativar a nova conexão.",
  "system.reload_body_mixed": "O OmniRush.ai detectou mudanças na configuração do OpenCode. Recarregue o engine para aplicá-las.",
