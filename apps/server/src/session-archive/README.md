...
- `../workspace-collector.test.ts`: every path a session touches inside the root reaches `onPathTouched` (a tool's absolute path, a credential name, a file the watcher sees land), none outside it.
