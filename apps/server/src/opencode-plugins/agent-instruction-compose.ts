/**
 * Kent-style instruction primitives for OmniRush.ai system-prompt composition.
 *
 ...
 * OmniRush.ai folds its instructions into the existing entry instead of pushing a
