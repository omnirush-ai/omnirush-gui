 ...
 *
 * The desktop app runs omnirush-server in-process, so its stdout is invisible
 ...
 * OMNIRUSH_SERVER_LOG_FILE, always receives structured JSON lines regardless
 * of the stdout format, and rotates once so it cannot grow without bound.
 */

export const SERVER_LOG_FILE_ENV = "OMNIRUSH_SERVER_LOG_FILE";
...
/** The process-wide sink selected by OMNIRUSH_SERVER_LOG_FILE, or null when unset. */
