 ...
 */
export const MATERIALIZED_DIR = join(".opencode", "omnirush", "inbox", "chat-attachments");
export const DERIVED_DIR = join(".opencode", "omnirush", "inbox", "pdf-pages");
 ...
 * under `.opencode/omnirush/inbox/pdf-pages/` for tools and people.
 */
