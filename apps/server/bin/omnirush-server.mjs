...
const binaryName = process.platform === "win32" ? "omnirush-server.exe" : "omnirush-server";
...
console.error(
  `Unable to find an OmniRush.ai server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
