# OmniRush.ai Models task analytics
...
Task analytics is included with a paid OmniRush.ai Models subscription. An internal
...
```mermaid
flowchart LR
  App[OmniRush.ai task] --> Inference[Existing OmniRush.ai inference]
