...
const redisKeyPrefix = "omnirush:diagnostics:mock-authorization:v1"
const subjectPattern = /^[a-f0-9]{64}$/u

declare global {
  var __omnirushDiagnosticsMockAuthorizations: Map<string, number> | undefined
}

const localAuthorizations = globalThis.__omnirushDiagnosticsMockAuthorizations ??= new Map()
