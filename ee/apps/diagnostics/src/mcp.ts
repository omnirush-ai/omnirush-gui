import { EGRESS_DIAGNOSTIC_RUN_HEADER } from "@omnirush/types/den/egress-diagnostics"
...
export async function handleMcpRequest(request: Request, rawBody: string): Promise<HandledResponse> {
  ...
  if (value.method === "initialize") {
    ...
    return json(200, rpcResult(id, {
      ...
      instructions: "Synthetic OmniRush.ai Diagnostics endpoint. No customer content is returned or retained.",
      protocolVersion: version,
      serverInfo: { name: "omnirush-diagnostics", version: "1.0.0" },
    }), {
