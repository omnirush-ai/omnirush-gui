...
} from "@omnirush/types/den/connect-diagnostics"
import { diagnosticsRedisConfig } from "./config"

const incidentHistoryKey = "omnirush:diagnostics:connect-incidents:v1"
const maximumIncidentHistory = 10_000
const retentionMs = CONNECT_DIAGNOSTIC_RETENTION_SECONDS * 1_000

declare global {
  var __omnirushDiagnosticsConnectIncidents: StoredConnectDiagnosticIncident[] | undefined
}

const localIncidents = globalThis.__omnirushDiagnosticsConnectIncidents ??= []
