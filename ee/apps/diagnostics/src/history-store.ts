...
const historyKey = "omnirush:diagnostics:wire-history:v1"
const historyRunsKey = "omnirush:diagnostics:wire-history-runs:v1"
const maximumHistory = 200
const maximumRunHistory = 50
const retentionSeconds = 86_400

declare global {
  var __omnirushDiagnosticsLocalHistory: WireExchange[] | undefined
  var __omnirushDiagnosticsLocalRunHistory: Map<string, WireExchange[]> | undefined
}

const localHistory = globalThis.__omnirushDiagnosticsLocalHistory ??= []
const localRunHistory = globalThis.__omnirushDiagnosticsLocalRunHistory ??= new Map()
