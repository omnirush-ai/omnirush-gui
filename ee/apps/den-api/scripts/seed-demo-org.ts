...
const DEMO_OWNER_PASSWORD = process.env.DEN_DEMO_OWNER_PASSWORD?.trim() || "OmniRushDemo123!"
...
function assertSafeDevTarget() {
  if (!env.devMode) {
    throw new Error("Refusing to seed demo data unless OMNIRUSH_DEV_MODE=1.")
  }
  if (env.dbMode !== "mysql") {
...
function githubHeaders() {
  return {
    ...
    "User-Agent": "omnirush-den-demo-seed",
