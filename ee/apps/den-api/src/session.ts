import { and, eq, gt, lt, lte } from "@omnirush-ee/den-db/drizzle"
import { AuthSessionTable, AuthUserTable } from "@omnirush-ee/den-db/schema"
...
const BETTER_AUTH_SESSION_COOKIE_NAMES = [
  "omnirush-den.session_token",
  "__Secure-omnirush-den.session_token",
