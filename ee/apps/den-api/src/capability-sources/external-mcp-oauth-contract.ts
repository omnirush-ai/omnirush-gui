import type { ExternalMcpOAuthCallbackMode } from "@omnirush-ee/den-db/schema"
...
function usesHostedDirectApiMigration(): boolean {
  ...
  return web.protocol === "https:"
    && api.protocol === "https:"
    && web.hostname === "app.omnirushlabs.com"
    && (api.hostname === "api.app.omnirushlabs.com" || api.hostname === "api.omnirushlabs.com")
}
