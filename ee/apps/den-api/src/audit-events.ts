import { AuditEventTable } from "@omnirush-ee/den-db/schema"
...
export const ORGANIZATION_AUDIT_ACTIONS = {
  ...
  omniRushWebComplimentaryAccessGranted: "organization.omnirush_web.complimentary_access_granted",
  omniRushWebComplimentaryAccessRevoked: "organization.omnirush_web.complimentary_access_revoked",
...
export function isOrganizationAuditAlertAction(action: OrganizationAuditAction) {
  switch (action) {
    ...
    case ORGANIZATION_AUDIT_ACTIONS.omniRushWebComplimentaryAccessGranted:
    case ORGANIZATION_AUDIT_ACTIONS.omniRushWebComplimentaryAccessRevoked:
