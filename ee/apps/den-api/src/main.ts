const DEVELOPMENT_CONDITIONS_REEXEC = "OMNIRUSH_DEN_DEVELOPMENT_CONDITIONS_REEXEC"
...
if (process.env.OMNIRUSH_DEV_MODE === "1" && process.env[DEVELOPMENT_CONDITIONS_REEXEC] !== "1") {
