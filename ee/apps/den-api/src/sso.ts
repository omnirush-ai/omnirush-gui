import { and, eq, isNotNull, isNull } from "@omnirush-ee/den-db/drizzle"
import { AuthAccountTable, ExternalIdentityTable, SsoConnectionTable, SsoProviderTable } from "@omnirush-ee/den-db/schema"
...
export function buildOrganizationSsoProviderId(organizationId: OrganizationId) {
  return `omnirush-sso-${organizationId}`
}
