...
import type { AutomationList } from "@omnirush/types/automations"

export const AGENT_AUTOMATION_INDEX_URI = "automation://index.json"
export const AGENT_AUTOMATION_INDEX_SCHEMA = "https://schemas.omnirushlabs.com/automations/discovery/0.2.0/schema.json"
...
export function registerAgentAutomationResources(input: {
  ...
  input.server.registerResource("agent-automations-index", AGENT_AUTOMATION_INDEX_URI, {
    ...
    description: "Discovery index of the Automations this OmniRush.ai member owns, with live schedule and run state.",
