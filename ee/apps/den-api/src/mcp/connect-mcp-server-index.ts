...
export function registerConnectMcpServerIndex(input: {
  ...
  input.server.registerResource("omnirush-connect-mcp-servers", CONNECT_MCP_SERVER_INDEX_URI, {
    title: "OmniRush.ai Connect MCP servers",
    description: "Member-authorized MCP servers available through OmniRush.ai Connect.",
