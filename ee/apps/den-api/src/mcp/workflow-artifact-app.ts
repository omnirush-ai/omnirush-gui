...
export { workflowArtifactPayloadSchema } from "@omnirush/types/workflows"

export const WORKFLOW_ARTIFACT_APP_RESOURCE_URI = "ui://omnirush/workflow-artifact/v1/view.html"
...
<head>
  ...
  <title>OmniRush.ai Workflow Artifact</title>
  <style>
    :root {
...
<body>
  ...
  <script>
    (function () {
      'use strict';
      var INIT_ID = 'omnirush-workflow-artifact:init';
      ...
      post({
        ...
        params: {
          appInfo: { name: 'OmniRush.ai Workflow Artifact', version: '1.0.0' },
          appCapabilities: {},
