...
import { skillCreatedAppHtml } from "@omnirush/mcp-apps/skill-created"
import {
  skillCreatedAppSchemaVersion,
  skillCreatedPayloadSchema,
  type SkillCreatedPayload,
} from "@omnirush/types/skill-created-app"
import { z } from "zod"

export { skillCreatedPayloadSchema } from "@omnirush/types/skill-created-app"

export const SKILL_CREATED_APP_RESOURCE_URI = "ui://omnirush/skill-created/v1/view.html"
...
export function registerAgentSkillCreatedApp(input: {
  ...
  registerAppTool(
    ...
    CREATE_SKILL_TOOL_NAME,
    {
      title: "Create skill",
      description: [
        "Create one private OmniRush.ai Cloud skill in a new Plugin.",
  ...
  registerAppTool(
    ...
    UPDATE_SKILL_TOOL_NAME,
    {
      title: "Update skill",
      description: [
        "Update one existing OmniRush.ai Cloud skill by creating a new immutable version, without creating a duplicate Plugin.",
...
export function registerAgentSkillCreatedResource(server: McpServer) {
  registerAppResource(
    server,
    "OmniRush.ai Skill Created",
    SKILL_CREATED_APP_RESOURCE_URI,
    {
      description: "A compact confirmation for a newly created or updated OmniRush.ai Cloud skill.",
