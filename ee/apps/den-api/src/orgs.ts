import { and, asc, count, eq, gt, inArray, isNotNull, isNull, sql } from "@omnirush-ee/den-db/drizzle"
import {
  AuthSessionTable,
  AuthUserTable,
...
export async function getInvitationPreview(invitationIdRaw: string): Promise<InvitationPreview | null> {
  ...
  return {
    ...
    organization: {
      ...
      branding: {
        appName: typeof organizationMetadata.brandAppName === "string" ? organizationMetadata.brandAppName : "OmniRush.ai",
