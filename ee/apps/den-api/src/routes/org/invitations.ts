import { and, desc, eq, isNull } from "@omnirush-ee/den-db/drizzle"
import { AuthUserTable, InvitationTable, MemberTable, OrganizationTable } from "@omnirush-ee/den-db/schema"
    ...
    try {
      await sendEmail({
        ...
        props: {
          ...
          invitedByName: user.name ?? user.email ?? "OmniRush.ai",
