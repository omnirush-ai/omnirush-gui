...
export const DEFAULT_OMNIRUSH_MARKETPLACE_NAME = "OmniRush.ai Marketplace"
export const DEFAULT_OMNIRUSH_MARKETPLACE_DESCRIPTION = "Built-in OmniRush.ai AI capabilities available in the desktop app after sign-in."
export const DEFAULT_OMNIRUSH_MARKETPLACE_LOGO_URL = "/omnirush-mark.svg"
