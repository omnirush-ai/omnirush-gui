...
const omniRushWebAccessRequiredSchema = z.object({
  ...
  message: z.string(),
}).meta({ ref: "WorkerRuntimeOmniRushWebAccessRequiredError" })
  ...
  app.get(
    ...
    describeRoute({
      ...
      responses: {
        ...
        403: jsonResponse("OmniRush.ai Web access is required to use a cloud worker runtime.", omniRushWebAccessRequiredSchema),
  ...
  app.post(
    ...
    describeRoute({
      ...
      responses: {
        ...
        403: jsonResponse("OmniRush.ai Web access is required to upgrade a cloud worker runtime.", omniRushWebAccessRequiredSchema),
        404: jsonResponse("The worker could not be found.", notFoundSchema),
      },
    }),
    orgMemberRoute({ useUserOrganizations: true }),
