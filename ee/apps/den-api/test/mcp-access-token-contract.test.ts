...
const schema = await import("@omnirush-ee/den-db/schema")
const { createDenTypeId } = await import("@omnirush-ee/utils/typeid")
...
const tokenUseClaim = "https://omnirushlabs.com/token_use"
const resourceClaim = "https://omnirushlabs.com/resource"
const orgIdClaim = "https://omnirushlabs.com/org_id"
const grantIdClaim = "https://omnirushlabs.com/grant_id"
const userId = createDenTypeId("user")
const organizationId = createDenTypeId("organization")
const sessionId = createDenTypeId("session")
const memberId = createDenTypeId("member")
const firstPartyClientId = "omnirush-desktop"
