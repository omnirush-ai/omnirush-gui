...
const needsSignInStatus: ExternalConnectionStatus = {
  ...
  action: {
    ...
    url: "https://app.omnirushlabs.com/dashboard/connections/emc_gmail",
  },
}
...
test("connection status payloads carry the exact human action for native rendering", () => {
  ...
  expect(fallback).toContain("Open: https://app.omnirushlabs.com/dashboard/connections/emc_gmail")
