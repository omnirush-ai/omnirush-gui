...
const bundleRoot = join(import.meta.dir, "../../../../integrations/agent-plugins/omnirush-connect")

describe("Agent Plugins v1", () => {
  test("ships a published 1.0 package with a valid OmniRush.ai Connect MCP configuration", async () => {
    ...
    expect(manifestResult).toMatchObject({
      manifest: { name: "omnirush-connect" },
      ok: true,
      schemaVersion: "1.0.0",
      warnings: [],
    })
