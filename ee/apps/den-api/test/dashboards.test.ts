...
import { eq, inArray } from "@omnirush-ee/den-db/drizzle"
import {
  AuthUserTable,
...
process.env.DATABASE_URL = process.env.DATABASE_URL ?? "mysql://root:password@127.0.0.1:3306/omnirush_test_dashboards"
...
const readOnlyElement = {
  serverName: "omnirush-app-host-connect-0123456789ab",
  connectionId: "emc_01dashboardfixture0000000000",
  toolName: "render_report",
  projectedToolName: "omnirush-app-host-connect-0123456789ab_render_report",
...
const writeElement = {
  ...
  projectedToolName: "omnirush-app-host-connect-0123456789ab_create_ticket",
