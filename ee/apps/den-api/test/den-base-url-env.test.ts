...
describe("DEN_BASE_URL environment defaults", () => {
  ...
  test("supports explicit shared cookie domains for sibling web and API hosts", () => {
    expect(probeDenUrls({
      BETTER_AUTH_URL: "https://app.omnirushlabs.com",
      DEN_API_PUBLIC_URL: "https://api.omnirushlabs.com",
      DEN_BETTER_AUTH_COOKIE_DOMAIN: "omnirushlabs.com",
      CORS_ORIGINS: "https://app.omnirushlabs.com,https://api.omnirushlabs.com,https://api.app.omnirushlabs.com",
    })).toMatchObject({
      betterAuthUrl: "https://app.omnirushlabs.com",
      betterAuthCookieDomain: "omnirushlabs.com",
      webUrl: "https://app.omnirushlabs.com",
      apiPublicUrl: "https://api.omnirushlabs.com",
      corsOrigins: ["https://app.omnirushlabs.com", "https://api.omnirushlabs.com", "https://api.app.omnirushlabs.com"],
      betterAuthTrustedOrigins: ["https://app.omnirushlabs.com"],
      webAppHosts: ["app.omnirushlabs.com"],
    })
  })
