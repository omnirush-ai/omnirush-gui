...
function validMcpJwtPayload(input: { resource: string; clientId?: string }) {
  return {
    ...
    "https://omnirushlabs.com/token_use": "mcp",
    "https://omnirushlabs.com/resource": input.resource,
    "https://omnirushlabs.com/org_id": createDenTypeId("organization"),
...
test("MCP JWTs without required scopes return insufficient_scope", async () => {
  jwtPayload = {
    ...
    scope: "profile",
    "https://omnirushlabs.com/token_use": "mcp",
    "https://omnirushlabs.com/resource": "http://127.0.0.1:8790/mcp/agent",
    "https://omnirushlabs.com/org_id": createDenTypeId("organization"),
    sid: createDenTypeId("session"),
  }
...
test("MCP JWTs with the wrong token use are rejected as invalid_token", async () => {
  jwtPayload = {
    ...
    azp: "client_mcp_test",
    scope: "mcp:read",
    "https://omnirushlabs.com/token_use": "session",
    "https://omnirushlabs.com/resource": "http://127.0.0.1:8790/mcp/agent",
    "https://omnirushlabs.com/org_id": createDenTypeId("organization"),
    sid: createDenTypeId("session"),
  }
...
test("MCP JWTs for the wrong resource are rejected as invalid_token", async () => {
  jwtPayload = {
    ...
    scope: "mcp:read",
    "https://omnirushlabs.com/token_use": "mcp",
    "https://omnirushlabs.com/resource": "http://127.0.0.1:8790/mcp",
    "https://omnirushlabs.com/org_id": createDenTypeId("organization"),
    sid: createDenTypeId("session"),
  }
