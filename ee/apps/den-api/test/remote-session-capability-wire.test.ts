...
/**
 * A witness omnirush-server: the exact native OpenCode routes the
...
beforeAll(async () => {
  ...
  deps = {
    ...
    // Remote sessions require OmniRush.ai Web access for the organization; this
...
test("remote-session capabilities drive a real omnirush-server wire with scoped guardrails", async () => {
