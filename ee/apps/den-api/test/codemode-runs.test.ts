import { createDenDb } from "@omnirush-ee/den-db"
import { eq, sql } from "@omnirush-ee/den-db/drizzle"
import { WorkflowRunTable } from "@omnirush-ee/den-db/schema"
...
const databaseUrl = "mysql://root:password@127.0.0.1:3306/omnirush_test_workflow_runs"
