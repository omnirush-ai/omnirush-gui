...
test("builds the installer asset URL for the configured release", () => {
  expect(installerReleaseAssetUrl("omnirush-enterprise-mac-arm64-9.9.9.dmg", {
    releaseTag: "v9.9.9+build 2",
    releaseRepo: "omnirush-ai/omnirush-gui",
  })).toBe("https://github.com/omnirush-ai/omnirush-gui/releases/download/v9.9.9%2Bbuild%202/omnirush-enterprise-mac-arm64-9.9.9.dmg")
})
...
test("builds the installer asset URL from the resolved default release", async () => {
  ...
  await expect(installerReleaseAssetUrl("omnirush-enterprise-win-x64-9.9.9.exe")).resolves.toBe(
    "https://github.com/omnirush-ai/omnirush-gui/releases/download/v9.9.9/omnirush-enterprise-win-x64-9.9.9.exe",
  )
})

test.each([
  ["mac-arm64", "v9.9.9", "omnirush-mac-arm64-9.9.9.dmg"],
  ["mac-x64", "9.9.9", "omnirush-mac-x64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "omnirush-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "omnirush-linux-x86_64-9.9.9.AppImage"],
  ["linux-arm64", "v9.9.9", "omnirush-linux-arm64-9.9.9.AppImage"],
...
test.each([
  ["mac-arm64", "v9.9.9", "omnirush-enterprise-mac-arm64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "omnirush-enterprise-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "omnirush-enterprise-linux-x86_64-9.9.9.AppImage"],
...
test.each([
  ["mac-arm64", "v9.9.9", "omnirush-cloud-mac-arm64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "omnirush-cloud-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "omnirush-cloud-linux-x86_64-9.9.9.AppImage"],
...
test("resolves only a mounted installer asset and reports its size", async () => {
  ...
  const fileName = "omnirush-enterprise-win-x64-9.9.9.exe"
  ...
  await expect(resolveConfiguredInstallerArtifact("omnirush-cloud-win-x64-9.9.9.exe")).resolves.toBeNull()
...
test("ignores a directory with the expected filename", async () => {
  const artifactsDir = mkdtempSync(path.join(os.tmpdir(), "ow-installer-artifacts-"))
  const fileName = "omnirush-cloud-win-x64-9.9.9.exe"
