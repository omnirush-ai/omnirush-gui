...
import { sql } from "@omnirush-ee/den-db/drizzle";
...
const shouldServeLocalModelCatalog = !isVercelRuntime && (process.env.NODE_ENV !== "production" || process.env.OMNIRUSH_DEV_MODE === "1");
  ...
  app.use(
    ...
    cors({
      ...
      allowHeaders: [
        ...
        "X-Webhook-Signature",
        "X-Test-Connection",
        "X-OmniRush-Session-Id",
        "X-OmniRush-Task-Id",
      ],
      allowMethods: ["GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"],
      exposeHeaders: ["X-OmniRush-Request-Id", "Retry-After"],
      maxAge: 600,
    }),
  );
}
