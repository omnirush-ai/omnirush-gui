...
function completionUrl(intentId: string, failed = false) {
  ...
  url.searchParams.set("omnirushSsoTest", intentId);
...
function SsoTestStartContent() {
      ...
      try {
        ...
        const response = await fetch(endpoint, {
          ...
          headers: {
            ...
            "x-omnirush-legacy-org-id": organizationId,
          },
  ...
  return (
    <DenStatusScreen
      ...
      description="This test does not enable SSO or replace your current OmniRush.ai session."
