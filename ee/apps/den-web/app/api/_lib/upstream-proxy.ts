...
/**
 * OmniRush.ai Cloud instances are served from Daytona preview origins that are
...
const CORS_ALLOW_HEADERS = "authorization,content-type,x-omnirush-org-id,x-omnirush-legacy-org-id,x-request-id,accept";
