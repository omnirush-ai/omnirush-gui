...
import { joinBaseUrl, readBaseUrlEnv } from "@omnirush/types/url";
import { denUrls } from "@omnirush-ee/utils";
import { DEFAULT_OMNIRUSH_WEB_URL } from "../../(den)/_lib/runtime-config";
  ...
  return NextResponse.json(
    {
      ...
      omnirushAppConnectUrl: readPublicRuntimeEnv("DEN_WEB_OMNIRUSH_APP_CONNECT_URL"),
      omnirushWebUrl: readPublicRuntimeEnv("DEN_WEB_OMNIRUSH_WEB_URL") || DEFAULT_OMNIRUSH_WEB_URL,
      omnirushAuthCallbackUrl: readPublicRuntimeEnv("DEN_WEB_OMNIRUSH_AUTH_CALLBACK_URL"),
      orgMode,
      singleOrgName: readPublicRuntimeEnv("DEN_SINGLE_ORG_NAME") || "OmniRush.ai",
