  ...
  return (
    <main className="min-h-screen bg-slate-950 px-6 py-12 text-white">
      <section className="mx-auto max-w-xl rounded-3xl border border-white/10 bg-white/10 p-8 shadow-2xl">
        <p className="text-sm uppercase tracking-[0.3em] text-cyan-200">OmniRush.ai MCP</p>
        <h1 className="mt-3 text-3xl font-semibold">Authorize MCP access</h1>
        <p className="mt-3 text-sm text-slate-300">`{clientId}` wants to access OmniRush.ai through MCP.</p>
        <div className="mt-6">
          <TemporaryAuthNotice />
        </div>
