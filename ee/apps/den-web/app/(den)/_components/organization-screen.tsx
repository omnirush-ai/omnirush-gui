...
export function OrganizationScreen() {
  ...
  const userDisplayName = useMemo(() => {
    ...
    return emailLocalPart || "OmniRush.ai User";
    ...
    if (intent === "join") {
      try {
        ...
        if (url.origin !== window.location.origin || url.pathname !== "/join-org" || !invitationId) {
          throw new Error("Paste the invitation link for this OmniRush.ai Cloud. Ask your team owner if you do not have one yet.");
        }
    ...
    <div className="flex min-h-screen flex-col bg-[#fafafa]">
      <header className="flex h-14 shrink-0 items-center justify-between gap-3 border-b border-gray-200 bg-white px-4 sm:px-6">
        <div className="flex items-center gap-2">
          <span className="text-[14px] font-medium text-gray-900">OmniRush.ai Cloud</span>
        </div>
            ...
            <section className="rounded-[1.75rem] border border-gray-200 bg-white p-5 shadow-xs sm:p-7 md:rounded-[2rem] md:p-10">
              <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-medium uppercase tracking-[0.18em] text-gray-400">OmniRush.ai</p>
