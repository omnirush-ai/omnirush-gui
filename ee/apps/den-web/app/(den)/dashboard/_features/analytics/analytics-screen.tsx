  ...
  return (
    <div className={analyticsPageClass}>
      <AnalyticsPageHeader orgSlug={activeOrg?.slug} active="adoption"
        title="Usage & adoption" description="Understand how your team works in OmniRush.ai, across models and providers."
      ...
      <p className="border-t border-[#e3e7ee] pt-4 text-xs leading-5 text-[#637291]">
        ...
        Usage data appears here once members sign in to the OmniRush.ai app and start running tasks.
      </p>
      </>
      )}
    </div>
