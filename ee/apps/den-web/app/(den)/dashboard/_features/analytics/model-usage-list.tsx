...
import type { TelemetryAnalyticsModels } from "@omnirush-ee/telemetry-contracts";
  ...
  return (
    <div className={`${analyticsSurfaceClass} p-5`}>
      ...
      <div className="mt-4 space-y-3">
        ...
        {!isLoading && models.length === 0 ? <AnalyticsEmptyState title="No model usage yet">Model sessions from your team will appear here as they use OmniRush.ai.</AnalyticsEmptyState> : null}
        {models.map((model) => (
          <div key={model.id}>
