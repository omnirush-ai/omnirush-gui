...
export default function StripeCheckingPage() {
  ...
  // Inference checkouts started from the OmniRush.ai Models page carry
        ...
        {failed ? (
          <>
            ...
            <p className="max-w-[480px] text-[14px] leading-6 text-gray-600">
              ...
              <a className="font-medium text-blue-600 hover:underline" href="mailto:team@omnirushlabs.com">team@omnirushlabs.com</a>.
            </p>
            <DenButton onClick={() => router.replace(destinationRoute)}>
              {returnTarget === "web" ? "Return to OmniRush.ai Web" : "Return to Billing"}
            </DenButton>
          </>
        ) : (
          <>
