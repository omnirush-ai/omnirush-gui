...
const ADVANCED_DESCRIPTIONS: Record<AdvancedTab, string> = {
  collections: "Collections contain plugins. The built-in OmniRush.ai collection and assigned collections show up inside the desktop app after sign-in.",
  "desktop-policies": "Control which desktop capabilities are available to the whole org, specific members, or teams.",
  "brand-appearance": "Customize how your workspace appears across OmniRush.ai.",
};
