...
import { desktopExecutionPolicySchema, type DesktopExecutionPolicy } from "@omnirush/types/den/desktop-policies";
...
function getDisabledPromptCopy(isDefault: boolean) {
  return isDefault
    ? "When organization prompts are off, OmniRush.ai defaults are used."
    : "When organization prompts are off, members inherit prompts from another matching policy or the default policy; if none apply, OmniRush.ai defaults are used.";
}
