...
const MOCK_PLUGINS: DenPlugin[] = [
  ...
  {
    id: "plg_omnirush_release",
    name: "OmniRush.ai Release Kit",
    slug: "omnirush-release-kit",
    description:
      "Internal plugin that automates OmniRush.ai release prep, server package checks, and changelog generation. Shipped by OmniRush.ai infra.",
    version: "2.3.1",
    author: "OmniRush.ai",
    category: "workflows",
    installed: true,
    source: { type: "github", repo: "omnirush-ai/omnirush-plugins" },
    skills: [
      { id: "sk_ow_release_prep", name: "Release Prep", description: "Bump versions across app, desktop, and omnirush-server in lockstep." },
