import { desktopExecutionPolicySchema, desktopPolicyDefaults, desktopPolicyDefinitions, resolveTeamAccessCapabilities, type DesktopExecutionPolicy, type TeamAccess } from "@omnirush/types/den/desktop-policies";
