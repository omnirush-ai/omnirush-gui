export const MCP_AUTHORIZATION_WINDOW_CLOSED_MESSAGE =
  "The sign-in window closed before OmniRush.ai confirmed the connection. Review the provider error, then try again.";

export const MCP_AUTHORIZATION_TIMEOUT_MESSAGE =
  "OmniRush.ai could not confirm the connection. Review the provider error in this window, then try again.";

export const MCP_AUTHORIZATION_UNCONFIRMED_CONNECTED_MESSAGE =
  "The provider responded, but OmniRush.ai could not confirm this account connection. Review the provider configuration, then try again.";
