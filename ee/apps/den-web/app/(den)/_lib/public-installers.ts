import type { DownloadCardInstallers } from "@omnirush/ui/react";
...
export async function getPublicInstallers(): Promise<{
  ...
  try {
    const response = await fetch("https://api.github.com/repos/omnirush-ai/omnirush-gui/releases/latest", {
