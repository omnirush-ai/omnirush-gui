...
const CLOUD_SIGNUP_URL = "https://app.omnirushlabs.com?mode=sign-up";
...
export function PricingGrid(props: PricingGridProps) {
  const cards: PricingCard[] = [
    ...
    },
    {
      ...
      href: "https://app.omnirushlabs.com/dashboard/billing",
      external: true,
      badge: "Recommended",
      features: [
    ...
    },
    {
      ...
      features: [
        ...
        { text: "OmniRush.ai Web", icon: Code2 },
  ...
  return (
    <section className="grid gap-8">
      ...
      <p className="text-center text-[12px] font-medium text-gray-500">
        Prices exclude taxes. Same pricing for OmniRush.ai Cloud and self-hosted. No deployment fees.
      </p>
      <p className="text-center text-[12px] font-medium text-gray-500">
        ...
        <a
          href="https://github.com/omnirush-ai/omnirush-gui/blob/main/ee/LICENSE"
          rel="noreferrer"
          target="_blank"
          className="underline"
        >
          OmniRush.ai EE License
        </a>{" "}
        and{" "}
