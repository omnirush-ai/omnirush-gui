...
export const AGENT_START_PROMPT = `Install OmniRush.ai on my computer, set up my first workspace, and open it ready to use. Follow the steps in https://omnirushlabs.com/start.md?v=${PROMPT_VARIANT}`;
...
const steps = ["Installs OmniRush.ai", "Creates your workspace", "Opens ready to run"];
    ...
    >
      ...
      >
        <div className="mb-2 text-[13px] text-[var(--lp-muted)]">
          Already use an AI agent? Paste this prompt — it installs OmniRush.ai for you.
        </div>
        <p className="text-[15px] leading-relaxed text-[#011627]">
          Install OmniRush.ai on my computer, set up my first workspace, and open it
          ready to use. Follow the steps in{" "}
          <span className="text-[var(--lp-muted)]">
            https://omnirushlabs.com/start.md?v={PROMPT_VARIANT}
          </span>
          <span
