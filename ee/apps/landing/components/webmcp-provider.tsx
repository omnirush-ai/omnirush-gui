...
const destinations: Record<string, string> = {
  home: "/",
  download: "https://app.omnirushlabs.com?mode=sign-up",
  pricing: "/pricing",
  enterprise: "/enterprise",
  cloud: "https://app.omnirushlabs.com",
  docs: "/docs",
  trust: "/trust",
  feedback: "/feedback",
}
  ...
  plans: [
    {
      ...
      cta: { label: "Get Started for free", href: "https://app.omnirushlabs.com?mode=sign-up" },
    },
    {
      id: "team-starter",
      name: "Team Starter",
      ...
      cta: { label: "Start team plan", href: "https://app.omnirushlabs.com/dashboard/billing" },
    },
    {
      id: "enterprise",
      name: "Enterprise",
...
const tools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Return OmniRush.ai's pricing tiers, what each includes, and the CTA destination. Read-only; does not navigate.",
    inputSchema: {
      type: "object",
      properties: {},
      additionalProperties: false,
