...
export const metadata = {
  title: "OmniRush.ai — Starter Success",
  description: "Thanks for pre-ordering OmniRush.ai Team Starter.",
  alternates: {
...
export default async function StarterSuccessPage() {
  ...
  const calHref = (() => {
    ...
    try {
      ...
      url.searchParams.set("notes", "Paid customer: OmniRush.ai Team Starter (12 months). Priority onboarding requested.");
        ...
        <div className="content-max-width px-6">
          <section className="animate-fade-up">
            ...
            <p className="max-w-2xl text-[16px] leading-relaxed text-gray-700">
              You&apos;re on track for getting access to OmniRush.ai Hosted in 7 days.
            </p>
          </section>
          ...
          <div className="mt-10 rounded-xl border border-gray-100 bg-white p-5 text-[13px] text-gray-500">
            OmniRush.ai stays open source, runs in any environment, and works with
            any model.
          </div>
