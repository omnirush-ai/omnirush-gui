...
const defaultAllowedOrigins = [
  ...
  "https://www.omnirushlabs.com",
  "https://omnirush.software",
  "https://www.omnirush.software",
  "http://localhost:3000",
  "http://127.0.0.1:3000",
  "http://localhost:3005",
  "http://127.0.0.1:3005",
...
const store = globalThis as typeof globalThis & {
  __omnirushLandingRateLimitStore?: Map<string, FixedWindowEntry>;
};

const rateLimitStore = store.__omnirushLandingRateLimitStore ?? new Map<string, FixedWindowEntry>();
store.__omnirushLandingRateLimitStore = rateLimitStore;
