...
const organizationSchema = {
  ...
  logo: "https://omnirushlabs.com/omnirush-mark.svg",
  sameAs: ["https://github.com/omnirush-ai/omnirush-gui"]
};
...
export const metadata = {
  metadataBase: new URL("https://omnirushlabs.com"),
  title: "OmniRush.ai — Open source Claude Cowork alternative for teams",
  description:
