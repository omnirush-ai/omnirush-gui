...
export const metadata: Metadata = {
  title: "OmniRush.ai Dashboard — build dashboards out of MCP Apps",
  description:
...
const dashboardFeatures = [
  ...
  {
    title: "Open standard",
    body: "Build to the spec once and it runs in OmniRush.ai and in every other host that implements MCP Apps. Apps built elsewhere work here too."
  },
  {
  ...
  },
  {
    ...
    body: "Follow the MCP Apps spec or point your agent at the reference repo. Next up: creating MCP Apps directly inside OmniRush.ai."
  }
];
...
const steps = [
  {
    ...
    body: "Add any MCP server that ships an app under Connectors. OmniRush.ai detects the app automatically."
  },
  {
    number: "02",
  ...
  },
  {
    number: "03",
    title: "Share it",
    body: "Toggle it on for the organization or specific teams. Members see it the next time they open OmniRush.ai."
  }
];
    ...
    <div className="relative min-h-screen overflow-x-hidden bg-[var(--lp-page)] text-[var(--lp-ink)]">
      <div className="relative z-10">
        <SiteNav
          ...
          mobilePrimaryLabel="Open OmniRush.ai Cloud"
          active="dashboard"
        />
        ...
        <main className="mx-auto w-full max-w-[1176px] px-6 pb-8">
          <section className="pt-16 md:pt-[88px]">
            <div className="flex flex-col justify-between gap-10 lg:flex-row lg:items-end">
              <div className="max-w-[650px]">
                <div className="mb-5 text-[15px] text-[var(--lp-muted)]">OmniRush.ai Dashboard · Powered by MCP Apps</div>
            ...
            <div className="mt-10 flex flex-col items-start gap-5 sm:flex-row sm:items-center">
              <div className="flex flex-col gap-3 sm:flex-row">
                <a href={CLOUD_SIGNUP_URL} className="lp-pill-primary">Open OmniRush.ai Cloud</a>
                <a href={MCP_APPS_URL} target="_blank" rel="noreferrer" className="lp-pill-secondary">Read the MCP Apps spec</a>
              </div>
              <span className="text-[13.5px] text-[var(--lp-body)] sm:ml-2">Any MCP App works as a widget. Nothing to rebuild for OmniRush.ai.</span>
            </div>
          </section>

          <section className="mt-[88px]" aria-label="OmniRush.ai Dashboard preview">
            <LpDashboardPreview />
          ...
          <section className="mt-[120px] grid gap-6 lg:grid-cols-3">
            ...
            <LpTonalCard className="flex flex-col p-7">
              ...
              <p className="mt-3 text-[14px] leading-[22px] text-[var(--lp-body)]">Compose it once in the admin panel and toggle it on for everyone. It appears in each member&apos;s OmniRush.ai.</p>
            </LpTonalCard>
          </section>
          ...
          <div className="mt-[120px]">
            <LpCta
              ...
              sub="Compose your first dashboard in OmniRush.ai Cloud, or build an MCP App and use it anywhere."
              primary={{ label: "Open OmniRush.ai Cloud", href: CLOUD_SIGNUP_URL }}
