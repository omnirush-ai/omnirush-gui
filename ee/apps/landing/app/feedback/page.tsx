...
export const metadata = {
  title: "OmniRush.ai — Feedback",
  description: "Send app feedback to the OmniRush.ai team with prefilled runtime context.",
  alternates: {
    canonical: "/feedback"
  },
  robots: {
  ...
  openGraph: {
    ...baseOpenGraph,
    url: "https://omnirushlabs.com/feedback"
  }
};
...
export default async function FeedbackPage({ searchParams }: PageProps) {
  ...
  const prefill: AppFeedbackPrefill = {
    source: readSearchParam(resolvedSearchParams, "source") || "omnirush-app",
    ...
    omnirushServerVersion: readSearchParam(resolvedSearchParams, "omnirushServerVersion"),
