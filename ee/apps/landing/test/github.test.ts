...
const repoUrl = "https://api.github.com/repos/omnirush-ai/omnirush-gui";
const latestReleaseUrl = "https://api.github.com/repos/omnirush-ai/omnirush-gui/releases/latest";
const releasesUrl = "https://api.github.com/repos/omnirush-ai/omnirush-gui/releases?per_page=50";
const fallbackReleaseUrl = "https://github.com/omnirush-ai/omnirush-gui/releases";
...
describe("getGithubData", () => {
  ...
  test("selects only public desktop assets when installer assets are listed first", async () => {
    const macArm64 = asset("omnirush-mac-arm64-0.17.38.dmg");
    const macX64 = asset("omnirush-mac-x64-0.17.38.dmg");
    const winArm64 = asset("omnirush-win-arm64-0.17.38.exe");
    const winX64 = asset("omnirush-win-x64-0.17.38.exe");
    const linuxX64 = asset("omnirush-linux-x86_64-0.17.38.AppImage");
    const release = releaseWithAssets([
      asset("OmniRush.ai-Installer-mac-arm64.dmg"),
      asset("OmniRush.ai-Installer-mac-x64.dmg"),
      asset("OmniRush.ai-Installer-win-x64.exe"),
      asset("omnirush-cloud-mac-arm64-0.17.38.dmg"),
      asset("omnirush-cloud-mac-x64-0.17.38.dmg"),
      asset("omnirush-cloud-win-x64-0.17.38.exe"),
      asset("omnirush-cloud-linux-x86_64-0.17.38.AppImage"),
      asset("omnirush-enterprise-mac-arm64-0.17.38.dmg"),
      asset("omnirush-enterprise-mac-x64-0.17.38.dmg"),
      asset("omnirush-enterprise-win-x64-0.17.38.exe"),
      asset("omnirush-enterprise-linux-x86_64-0.17.38.AppImage"),
      macArm64,
      macX64,
      winArm64,
      winX64,
