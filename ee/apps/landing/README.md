...
1. Install deps from repo root:
   `pnpm install`
2. Run the app:
   `pnpm --filter @omnirush-ee/landing dev`
...
2. Build command: `pnpm --filter @omnirush-ee/landing build`
3. Output: `.next`
4. Start command: `pnpm --filter @omnirush-ee/landing start`
5. Enable Vercel BotID for the project so protected form routes can reject automated submissions.

### Self-hosted

1. Build: `pnpm --filter @omnirush-ee/landing build`
2. Start: `pnpm --filter @omnirush-ee/landing start`
