...
export const homeFaq: FaqEntry[] = [
  ...
  {
    question: "How is OmniRush.ai different from Claude Cowork?",
    answer:
      "OmniRush.ai is open source, works with 50+ LLMs from any provider instead of a single vendor, and runs locally so your files stay on your machine. Teams can package skills, MCP servers, plugins, and configs into a single link that teammates import in one click."
  },
  {
    question: "Which AI models does OmniRush.ai support?",
    answer:
  ...
  {
    question: "Does OmniRush.ai send my files to the cloud?",
    answer:
  ...
  {
    question: "Do I need to be technical to use OmniRush.ai?",
    answer:
      "No. OmniRush.ai is a point-and-click desktop app. Skills, MCP servers, and plugins shared by a teammate import in one click — no terminal or setup guide required."
  }
];
