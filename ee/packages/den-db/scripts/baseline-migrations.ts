 ...
 *
 * Usage:
 *   pnpm --filter @omnirush-ee/den-db db:baseline              # dry run
 *   pnpm --filter @omnirush-ee/den-db db:baseline -- --yes     # apply
 *   pnpm --filter @omnirush-ee/den-db db:baseline -- --yes --through 0020_breezy_siren
 *
