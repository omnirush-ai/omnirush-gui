...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "omnirush-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "omnirush-ai/omnirush-gui"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "omnirush-download-stats",
  }
